...
const ProjectForm = ({setShowProjectForm, type,setOpen, showProjectForm,projectId}) => {
    const { register, handleSubmit, errors, isSubmitting, handleOnSubmit } = useProject(setShowProjectForm, showProjectForm, setOpen, type,projectId)

    return (
        <div className="fixed h-screen w-screen flex items-center justify-center bg-black/70 top-0 left-0">
            <div className="w-[50vw] rounded-2xl px-4 py-3 bg-white">
